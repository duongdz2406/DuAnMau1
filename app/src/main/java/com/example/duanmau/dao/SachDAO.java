...
public class SachDAO {
    ...
    public ArrayList<Sach> getDSDauSach(){
        ...
        Cursor cursor = sqLiteDatabase.rawQuery("SELECT sc.masach,sc.tensach,sc.giathue,sc.maloai,lo.tenloai FROM SACH sc,LOAISACH lo WHERE sc.maloai =lo.maloai",null,null);
    ...
    public boolean themSach(String tensach,int giatien,int maloai){
